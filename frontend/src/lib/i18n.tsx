...
const uz = {
  ...
  cr_voice_result: 'Ovozdan tanildi',
  cr_voice_https: 'Brauzerda mikrofon faqat HTTPS da ishlaydi (domen ulangach). Hozircha ovozli vazifani Telegram botdan bering.',
  cr_voice_short: 'Juda qisqa yozildi — qaytadan urinib ko\'ring.', cr_pick_assignee: 'Bajaruvchini tanlang', cr_self_review: 'Bajaruvchi va tekshiruvchi bir odam bo\'lishi mumkin emas',
...
const ru: typeof uz = {
  ...
  cr_voice_processing: 'Распознаю…', cr_voice_off: 'Голосовой ввод не настроен', cr_voice_result: 'Распознано',
  cr_voice_https: 'Микрофон в браузере работает только по HTTPS (после подключения домена). Пока используйте голос в Telegram-боте.',
  cr_voice_short: 'Запись слишком короткая — попробуйте ещё раз.', cr_pick_assignee: 'Выберите исполнителя',
...
const en: typeof uz = {
  ...
  cr_voice_result: 'Recognized',
  cr_voice_https: 'Browser microphone needs HTTPS (available once the domain is connected). Use the Telegram bot for voice until then.',
  cr_voice_short: 'Recording too short — please try again.', cr_pick_assignee: 'Pick an assignee', cr_self_review: 'Assignee and reviewer cannot be the same person', cr_crew: 'Crew size', cr_type_hint: 'Work type defines checklist and required photos',
